...
?>
	...
	<div class="main-grid-container">
		<div class="Menu">
  		...
  		<div class="Content">
			<h1 style="margin: 5px 0;">Add user</h1>
			<p style="font-size: 1.1em;">Enter a username and password. Then, you'll be able to edit more user options.</p>
			<form method="post">
				<div class="adduser-grid-container">
					...
					<div class="empty"></div>
  					<div class="username_text"><input type="text" name="username" id="username" required><p>Required. 150 characters or fewer.</p></div>
  					<div class="password_text"><input type="password" name="password" id="password" required>
  					...
  					<div class="password_cfm_text"><input type="password" name="password_confirm" id="password_cfm" required>
					...
					<div class="submit">
						...
						<input type="submit" name="submit" value="SAVE" style="background-color: darkred;">
					</div>
				</div>
			</form>
		</div>
